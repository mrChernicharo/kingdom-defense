...
export const LEVELS: Level[] = [
    {
        ...
        waves: [
            ...
            [
                ...
                [Orc, 120, 0],
                [Orc, 170, 0],
                [Skeleton, CANVAS_WIDTH - 30, 0],
                [Skeleton, CANVAS_WIDTH - 80, 0],
                [Skeleton, CANVAS_WIDTH - 130, 0],
                [Skeleton, CANVAS_WIDTH - 180, 0],
            ],
            [
                [Orc, 20, 0],
                [Orc, 60, 0],
            ...
            [
                ...
                [Orc, 160, 0],
                [Orc, 195, 0],
                [Skeleton, CANVAS_WIDTH - 25, 0],
                [Skeleton, CANVAS_WIDTH - 60, 0],
                [Skeleton, CANVAS_WIDTH - 95, 0],
                [Skeleton, CANVAS_WIDTH - 130, 0],
                [Skeleton, CANVAS_WIDTH - 165, 0],
                [Skeleton, CANVAS_WIDTH - 200, 0],
            ],
            [
                [Orc, 20, 0],
                ...
                [Orc, 200, 0],
                [Skeleton, CANVAS_WIDTH - 25, 0],
                [Skeleton, CANVAS_WIDTH - 55, 0],
                [Skeleton, CANVAS_WIDTH - 85, 0],
                [Skeleton, CANVAS_WIDTH - 115, 0],
                [Skeleton, CANVAS_WIDTH - 145, 0],
                [Skeleton, CANVAS_WIDTH - 175, 0],
                [Skeleton, CANVAS_WIDTH - 205, 0],
            ],
            [
                [Orc, 20, 0],
                [Orc, 50, 0],
